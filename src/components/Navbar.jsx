        ...
        <div className="lg:hidden absolute top-full left-0 w-full bg-white border-b border-gray-200 shadow-lg">
          <div className="px-4 pt-2 pb-6 space-y-4">
            ...
            <div className="pt-4 border-t border-gray-200 space-y-3">
              <button className="w-full py-3 px-5 text-gray-700 hover:text-gray-900 font-medium text-base border border-gray-200 rounded-lg hover:bg-gray-50">Sign In</button>
